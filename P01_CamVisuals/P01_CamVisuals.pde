...
void oscEvent(OscMessage oscMsg){
  ...
  if(oscMsg.checkAddrPattern("/eff/thres") == true){
    if(oscMsg.checkTypetag("ifi")){
      int thr_mode = oscMsg.get(0).intValue();
      thresLimit = (int) oscMsg.get(1).floatValue();
